...
>(({ className, children, fallbackTitle = 'Dialog', fallbackDescription = '', onOpenAutoFocus, onCloseAutoFocus, ...props }, ref) => {
    // Handle focus management to prevent aria-hidden issues
